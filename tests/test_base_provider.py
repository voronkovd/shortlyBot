...
class TestBaseProvider:
    ...
    def test_download_video_success(self, mock_getsize, mock_glob, mock_ydl_class, provider):
    ...
    @patch('providers.base.glob.glob')
    @patch('providers.base.os.path.getsize')
    def test_download_video_with_string_ref(self, mock_getsize, mock_glob, mock_ydl_class, provider):
    ...
    @patch('providers.base.glob.glob')
    @patch('providers.base.os.path.getsize')
    def test_download_video_format_error_fallback(self, mock_getsize, mock_glob, mock_ydl_class, provider):
